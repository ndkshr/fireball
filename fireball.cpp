...
char MENU_stat(char mch = '\0')
{
  ...
  cout << "STATUS    : " << "PLAYING";
  gotoxy(55, 6);
  cout << "TIME LEFT : " << ((left / 1000) + 1) << " sec(s)";
  gotoxy(54, 7);
  cout << "--------------------------";
  gotoxy(52, 9);
  cout << "Press [Enter]: PAUSE / MENU";
  if ((int)mch == 13)
  {
    cout << "\a";
    gotoxy(55, 5);
...
void blockbuster(char check)
{
  ...
  {
  case 'B':
    game[ball_i - 1][ball_j + 1] = 'I';
    game[ball_i - 1][ball_j] = 'I';
    game[ball_i - 1][ball_j - 2] = 'I';
    break;
  case 'C':
    game[ball_i - 1][ball_j] = 'I';
    break;
...
songchange:
  ...
  case 0:
    ...
    break;
  case 1:
    PlaySound(TEXT("C:\\Users\\ANSYS\\Desktop\\Burn It To The Ground.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
    break;
  case 2:
    PlaySound(TEXT("C:\\Users\\ANSYS\\Desktop\\linkin park - numb lyrics.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
    break;
  case 3:
    PlaySound(TEXT("C:\\Users\\ANSYS\\Desktop\\003 Taekwondo Best Knockouts.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
    break;
  case 4:
    PlaySound(TEXT("C:\\Users\\ANSYS\\Desktop\\waiting for the end.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
    break;
  }
skip:
  do
